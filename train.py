...
#     model.train(
#         data_path='dataset.tfrecords',
#         num_epoch=num_epoch
#     )
#     model.train(
#         data_path='icdar13.tfrecords',
#         num_epoch=num_epoch
#     )
#     model.train(
#         data_path='iiit5k.tfrecords',
#         num_epoch=num_epoch
#     )
    
#     model.train(
#         data_path='svt.tfrecords',
#         num_epoch=num_epoch
#     )
    model.train(
...
#     model.train(
#         data_path='train_tickets.tfrecords',
#         num_epoch=num_epoch
#     )
#     model.train(
#         data_path='total.tfrecords',
#         num_epoch=num_epoch
#     )
